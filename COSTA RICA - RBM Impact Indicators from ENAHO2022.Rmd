...
ENAHO_2022_usuarios_ <- read_sav(here::here("data-raw","ENAHO2022.sav"))
...
## Nicaraguans
total_nic <- ENAHO_2022_usuarios_%>%
  filter(LugNac == 2)%>%
  count(.,wt=FACTOR)


## CostaRicans
total_crc <- ENAHO_2022_usuarios_%>%
  filter(LugNac == 0 | LugNac == 1)%>%
  count(.,wt=FACTOR)

# 2.1 Proportion of PoC living below the national poverty line. [GCR 2.1.1 and SDG 1.2.1]

## np1 = extreme poverty  and np2= poverty (no extreme)

poverty_nic <- ENAHO_2022_usuarios_%>%
  filter( LugNac == 2, np == 1 | np== 2)%>%
  count(.,wt=FACTOR)

poverty_crc <- ENAHO_2022_usuarios_%>%
...
access_nic <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 2)%>%
...
access_crc <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 0 | LugNac == 1)%>%
  select(c(FACTOR,ID_HOGAR,REGION,ZONA,TamHog,LugNac,V12,V13A,V14A,V15,V16))%>%
  mutate(.,drinking_water= 
           if_else(V12 == 5 | V12 == 6 | V12 == 7, "No","Yes"))%>%
...
health_nic <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 2)%>%
...
health_crc <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 2)%>%
  select(c(FACTOR,ID_HOGAR,REGION,ZONA,TamHog,LugNac,A11))%>%
filter(A11 == 0)%>%
  count(.,wt=FACTOR)
...
ggplot(data=indicators, 
  ...
  labs(x = "Estimate", y = "",
       ...
       caption = glue::glue("Encuesta Nacional de Hogares (ENAHO) 2022\n",
...
nic_primary_age <- ENAHO_2022_usuarios_%>%
...
nic_primary_enrolled <- ENAHO_2022_usuarios_%>%
  filter(LugNac == 2, A5 == 6 | A5== 7 | A5 == 8 
         | A5 == 9 | A5 == 10 | A5 == 11)%>%
  select(FACTOR,LugNac,A5,A13)%>%
  filter(.,A13 == 3)%>%
...
crc_primary_age <- ENAHO_2022_usuarios_%>%
  filter(LugNac == 0 | LugNac == 1, A5 == 6 | A5== 7 | A5 == 8 
         | A5 == 9 | A5 == 10 | A5 == 11)%>%
  select(FACTOR,LugNac,A5,A13)%>%
  count(.,wt=FACTOR)
 
crc_primary_enrolled <- ENAHO_2022_usuarios_%>%
  filter(LugNac == 0 | LugNac == 1, A5 == 6 | A5== 7 | A5 == 8 
         | A5 == 9 | A5 == 10 | A5 == 11)%>%
  select(FACTOR,LugNac,A5,A13)%>%
  filter(.,A13 ==3)%>%
...
nic_secundary_age <- ENAHO_2022_usuarios_%>%
...
nic_secundary_enrolled <- ENAHO_2022_usuarios_%>%
  filter(LugNac == 2, A5 == 12 | A5== 13 | A5 == 14 
         | A5 == 15 | A5 == 16 | A5 == 17)%>%
  select(FACTOR,LugNac,A5,A13)%>%
  filter(.,A13 == 4)%>%
...
crc_secundary_age <- ENAHO_2022_usuarios_%>%
...
crc_secundary_enrolled <- ENAHO_2022_usuarios_%>%
  filter(LugNac == 0 | LugNac == 1, A5 == 12 | A5== 13 | A5 == 14 
         | A5 == 15 | A5 == 16 | A5 == 17)%>%
  select(FACTOR,LugNac,A5,A13)%>%
  filter(.,A13 == 4)%>%
...
nic_clean_fuels <- ENAHO_2022_usuarios_%>%
...
crc_clean_fuels <- ENAHO_2022_usuarios_%>%
  select(.,c(FACTOR,ID_HOGAR,REGION,ZONA,TamHog,LugNac,V16))%>%
  mutate(.,clean_fuels = if_else(V16 == 0 | V16 == 3 | V16 == 4,0,1))%>%
...
nic_CondAct2 <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 2)%>%
  select(c(FACTOR,ID_HOGAR,REGION,ZONA,TamHog,LugNac,A5,B6,B7A,B7B,B7C,B7D,B7E,
           B7F,B7G,B7H,B7I,B7J,B7K,B8))%>%
  filter(A5>15,(B6==8 | B6==9) & (B7A==1 | B7B == 2 | B7C == 3 | B7D == 4 
                                  | B7E == 5 | B7F == 6 | B7G == 7 | B7H == 8 |
                                    B7I == 9 | B7J == 10 | B7K == 11 | B8 == 1 | B8 == 2| B8 == 3))%>%
  count(.,wt=FACTOR)


nic_CondAct1 <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 2)%>%
  select(c(FACTOR,ID_HOGAR,REGION,ZONA,TamHog,LugNac,A5,B1,B2,B3,B5,B6,B7A,B7B,B7C,B7D,B7E,
           B7F,B7G,B7H,B7I,B7J,B7K,B8))%>%
  filter(A5>15,  (B1== 1 | B2 == 1 | B2 == 2| B2 == 3| B2 == 4| B2 == 5| B2 == 6| B2 == 7
            | B2 == 8 | B3 == 1 | B5 == 1 | B5 == 2 | B5 == 3 | B5 == 4 | B5 == 5))%>% 
  count(.,wt=FACTOR)

ind133_nic <- nic_CondAct2/(nic_CondAct1+nic_CondAct2)


# Costaricans

crc_CondAct2 <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 0 | LugNac == 1)%>%
  select(c(FACTOR,ID_HOGAR,REGION,ZONA,TamHog,LugNac,A5,B6,B7A,B7B,B7C,B7D,B7E,
           B7F,B7G,B7H,B7I,B7J,B7K,B8))%>%
  filter(A5>15,(B6==8 | B6==9) & (B7A==1 | B7B == 2 | B7C == 3 | B7D == 4 
...
crc_CondAct1 <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 0 | LugNac == 1)%>%
   select(c(FACTOR,ID_HOGAR,REGION,ZONA,TamHog,LugNac,A5,B1,B2,B3,B5,B6,B7A,B7B,B7C,B7D,B7E,
           B7F,B7G,B7H,B7I,B7J,B7K,B8))%>%
  filter(A5>15, (B1== 1 | B2 == 1 | B2 == 2| B2 == 3| B2 == 4| B2 == 5| B2 == 6| B2 == 7
...
ind133_crc <- crc_CondAct2/(crc_CondAct1+crc_CondAct2)
...
nic_secure_tenure <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 2)%>%
...
crc_secure_tenure <-ENAHO_2022_usuarios_%>%
  filter( LugNac == 0  | LugNac == 1)%>%
  select(c(FACTOR,ID_HOGAR,REGION,ZONA,TamHog,LugNac,V2A))%>%
  filter( V2A == 1 | V2A == 2 | V2A == 3)%>%
  count(.,wt=FACTOR)
