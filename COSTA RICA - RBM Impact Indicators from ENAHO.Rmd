...
data <- data |>
  ...
  mutate(CondAct = 
           ifelse(
    (A5>15 & (B1== "Sí" | 
    B2 == "Participó en labores agropecuarias" | 
    B2 == "Hizo algo para vender (costuras, manualidades, comidas)"| 
  B2 == "Vendió algún producto (alimentos, joyas, rifas o ventas por catálogo)"| 
  B2 == "Cuidó niños, ancianos o personas enfermas de otro hogar recibiendo pago en dinero o en especie"| 
  B2 == "Realizó algún servicio doméstico para personas de otro hogar recibiendo pago en dinero o en especie (limpiar, planchar)"| 
  B2 == "Realizó algún otro servicio (pintar uñas, corte de pelo, cuidar carros, etc.) recibiendo pago en dinero o en especie"| 
  B2 == "Realizó trabajos variados, camarones, chambas"| 
  B2 == "Hizo algún otro trabajo recibiendo pago en dinero o en especie"| 
  B3 == "Sí" | 
  B5 == "Vacaciones, incapacidad, huelga, permiso o suspensión de actividades, recibiendo sueldo o ingresos del negocio" | 
  B5 == "No llegaron clientes al local u oficina" | 
  B5 == "Pidió permiso sin goce de sueldo por un mes o menos" | 
  B5 == "Enfermedad, vacaciones sin recibir sueldo o ingresos por un mes o menos con seguridad de regreso al trabajo" | 
  B5 == "Suspensión actividad sin ingresos 1 mes o menos con seguridad regreso trab. (avería equipo, mal tiempo, falta mat.prima)")),
"Employed",
           
           
           ifelse(A5>15 & (B6 == "Podría, sin ninguna restricción" | 
          B6 == "Con ciertas condiciones laborales  (horario, lugar, otra)") &
        (B7A == "Sí" | 
           B7B == "Sí" | 
           B7C == "Sí" | 
           B7D == "Sí"  | 
           ...
           B7J == "Sí" | 
           B7K == "Sí" | 
           B8 == "Ya encontró trabajo" | 
           B8 == "Espera reinicio de operaciones o reapertura del negocio"| 
           B8 == "Espera respuesta de gestiones anteriores"),
...
```{r warning=FALSE, layout='Title and Content', ph=officer::ph_location_type(type="body")}
...
rbm_indicators <- 
 ...
 ggplot(data=indicators, 
  ...
  geom_text(aes(label= scales::label_percent(.1)(p)),
...
ind133_nic <-  svy|>
  filter(LugNac == "En Nicaragua") |>
  filter(CondAct == "Employed" | CondAct == "Unemployed") |>
   group_by(CondAct)|>
  summarize( p = survey_prop(vartype = "cv"))|>
  filter(CondAct == "Unemployed")
